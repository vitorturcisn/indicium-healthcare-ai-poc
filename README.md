...
A fonte oficial do conjunto de dados é o [Portal de Dados Abertos do SUS](https://dadosabertos.saude.gov.br/dataset/srag-2019-a-2026), que disponibiliza os bancos de SRAG organizados por ano e informa atualização periódica do banco corrente. 
...
> Os arquivos de dados brutos e os artefatos gerados podem ser mantidos fora do versionamento, especialmente quando o objetivo do repositório for publicar somente código e documentação.
...
A execução do snapshot utilizado neste projeto espera:
...
Se forem utilizados arquivos de outra data, atualize os nomes definidos na função `main()` do script.
...
Defina aqui a licença do projeto conforme a política do repositório e a organização responsável pela PoC.
