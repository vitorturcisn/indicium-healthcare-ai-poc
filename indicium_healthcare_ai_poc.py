...
Agente de monitoramento epidemiológico baseado em:
- LangGraph
- Google Gemini
- Tool Calling
- SQLite
- Pandas
- Matplotlib
- Busca web com validação de domínio

Objetivos:
1. Calcular métricas epidemiológicas de forma determinística.
2. Minimizar os dados enviados ao agente.
3. Preservar registros com dados ausentes nas variáveis não mandatórias.
4. Buscar contexto noticioso em fontes institucionais.
5. Aplicar guardrails de entrada, execução e saída.
6. Registrar auditoria das execuções.
"""
